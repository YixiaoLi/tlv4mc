 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: trace_config.h 116 2009-01-29 13:23:36Z ertl-honda $
 */
...
#define LOG_IMSTA_ALM_ENTER(almid, almtim, prcid) trace_4(LOG_TYPE_SVC|LOG_ENTER, TFN_MSTA_ALM, almid, almtim, prcid)
#define LOG_IMSTA_ALM_LEAVE(ercd) trace_2(LOG_TYPE_SVC|LOG_LEAVE, TFN_MSTA_ALM, ercd)
