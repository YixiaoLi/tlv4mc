...
trace_log_test(void)
{
	...
	/* タスク例外起動と終了 */
	SVC_PERROR(ras_tex(TASK1, 0x0001U));
	dly_tsk(10);
	ter_tsk(TASK1);
	SVC_PERROR(ras_tex(TASK2, 0x0001U));
	dly_tsk(10);
	ter_tsk(TASK2);
	SVC_PERROR(ras_tex(TASK3, 0x0001U));
	dly_tsk(10);
	ter_tsk(TASK3);
	dly_tsk(20);
	...
	/* 全タスク起床 */
	SVC_PERROR(wup_tsk(TASK1));
	dly_tsk(10);
	SVC_PERROR(wup_tsk(TASK2));
	dly_tsk(10);
	SVC_PERROR(wup_tsk(TASK3));
	dly_tsk(20);
