...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=15.5cm]{whole.png}
  \end{center}
  \caption{全体スクリーンショット}
  \label{fig:whole}
\end{figure}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=15.5cm]{str.png}
  \end{center}
  \caption{文字列可視化}
  \label{fig:str}
\end{figure}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=15.5cm]{strtask.png}
  \end{center}
  \caption{タスク文字列可視化}
  \label{fig:strtask}
\end{figure}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=15.5cm]{whole_str.png}
  \end{center}
