...
//#define LOG_STAT_SEM(p_semcb, p_tcb) trace_3(LOG_TYPE_SVC|LOG_ENTER, p_semcb->semcnt, p_tcb)
...
/* 周期ハンドラ */
#define LOG_CYC_ENTER(p_cyccb) trace_2(LOG_TYPE_SVC|LOG_ENTER, TFN_CYC, p_cyccb)
#define LOG_CYC_LEAVE(p_cyccb) trace_2(LOG_TYPE_SVC|LOG_LEAVE, TFN_CYC, p_cyccb)
...
/* アラームハンドラ */
#define LOG_ALM_ENTER(p_almcb) trace_2(LOG_TYPE_SVC|LOG_ENTER, TFN_ALM, p_almcb)
#define LOG_ALM_LEAVE(p_almcb) trace_2(LOG_TYPE_SVC|LOG_LEAVE, TFN_ALM, p_almcb)
