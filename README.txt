...
TraceLogVisualizer（以下，TLV)は，各種のログを可視化するWindowsアプリケー
ションである．TLVの大部分は，文部科学省 先導的ITスペシャリスト育成推進
プログラム『OJL(On-the-Job Learning)による最先端技術適応能力を持つIT 人
材育成拠点形成』の一環で，名古屋大学を中心に開発したものである．
...
以下の環境を，ソースコードの標準的なビルド環境として用いている．

	Microsoft Visual Studio 2010 Professional

※多くの警告が出力されるが，無償版（Visual Studio 2010 Express）でもビ
ルドは可能である．
